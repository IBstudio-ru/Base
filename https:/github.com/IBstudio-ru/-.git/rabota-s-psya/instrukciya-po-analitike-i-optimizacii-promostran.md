...
2. Перейдите в раздел **«Кампании»** \$\\rightarrow\$ **«Текущие»** и выберите нужную статью.
...
**А. Анализ заголовков (Группировка \$\\rightarrow\$ Заголовки)**
...
**Б. Анализ креативов (Группировка \$\\rightarrow\$ Изображения)**
