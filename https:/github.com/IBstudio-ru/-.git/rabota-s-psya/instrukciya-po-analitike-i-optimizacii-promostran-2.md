...
4. Перейдите в раздел **«Кампании»** \$\\rightarrow\$ **«Текущие»**. Здесь отображаются все активные или временно приостановленные статьи.

### 2\. Сопоставление с таблицей отчета

1. Откройте отчетную таблицу (Google Sheets) для нужного проекта.

2. Выберите статью для оптимизации, скопируйте ее название и найдите соответствующую кампанию в кабинете Яндекса.

3. *Нюанс:* Названия в таблице и в кабинете могут иногда отличаться (если заголовок меняли при прошлой оптимизации). В таком случае сопоставляйте статью по прямой ссылке, которая указана в конце отчетной таблицы.
...
-  Если интерес низкий (особенно ниже 2%), изучите ответы читателей:
   ...
   -  *«Не для меня»* -- ошибка в таргетинге. Нужно зайти в **«Настройки»** \$\\rightarrow\$ **«Интересы и привычки»** и скорректировать аудиторию.
