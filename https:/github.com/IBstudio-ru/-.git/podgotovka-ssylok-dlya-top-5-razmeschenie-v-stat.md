...
-  Выберите нужную ссылку. Нажмите «перейти и выбрать кнопку». Физически кликните на кнопку в интерфейсе настройки, чтобы система её запомнила. Нажмите «Добавить цель».

1. **Кнопки в товарном виджете**: В одном виджете обычно настраивается 5 целей (на каждый кликабельный элемент):
